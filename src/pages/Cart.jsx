...
function Cart() {
  ...
  return (
    <div className="bg-[oklch(98.2%_0.018_155.826)] dark:bg-black dark:text-[oklch(74.6%_0.16_232.661)] min-h-screen">
      <div className="flex items-center justify-between p-3">
        <h2 className="text-2xl md:text-3xl p-3">Cart</h2>
        {itemsInCart.length === 0 ? (
          <button
            className="hidden rounded-md p-2 text-white bg-[oklch(63.7%_0.237_25.331)] cursor-pointer mt-1"
        ...
        <div className="flex flex-col gap-6 rounded-lg p-3">
          {itemsInCart.map((itemInCart) => (
            <div
              ...
              className="bg-white dark:bg-[oklch(26.9%_0_0)] flex flex-col md:flex-row gap-4 p-2 rounded-lg"
            >
              <img
              ...
              <div className="flex flex-col flex-1 justify-between">
                ...
                <p className=" font-medium">
                  Price: ₹{itemInCart.featuredPrice}
                </p>
              </div>
            </div>
          ))}
      ...
      {itemsInCart.length === 0 ? (
        <h2 className="text-center">
          Your Cart is empty.
          <span>
            <i className="bi bi-cart-x text-5xl text-gray-600"></i>
          </span>
        </h2>
      ) : (
        <div className="p-3">
          <div className="bg-white dark:bg-[oklch(26.9%_0_0)] rounded-lg p-3">
            ...
            <Link to="/checkout">
              <button className="rounded-lg p-3 bg-[oklch(85.2%_0.199_91.936)] dark:text-black mt-3 cursor-pointer w-full md:w-48">
